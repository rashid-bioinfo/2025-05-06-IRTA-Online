...
humandate: "May 06 - 27, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
enddate: 2025-05-27        # machine-readable end date for the workshop in YYYY-MM-DD format like 2015-01-02
instructor: ["Khaoula Ferchichi", "Rashid Hussain", "Shaday Guerrero Flores", "Herbert Kudakwashe Nguruwe"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Carme Reverté", "Miguel Ángel López"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
email: [miguelangel.lopez@irta.cat]    # boxed, comma-separated list of contact email addresses for the host, lead instructor, or whoever else is handling questions, like ["marlyn.wescoff@example.org", "fran.bilas@example.org", "ruth.lichterman@example.org"]
...
<br><a href="{{ '/resources/' | relative_url }}">Python Notes</a><br><br>
<a href="{{ '/shell/' | relative_url }}">Linux Shell Notes</a>

<h2 id="installation">Getting Started</h2><br>
